...
console.log(yangle, xangle);
  if (true) {
    ...
    group.scale.x = (xangle * Math.PI) / 180; // Convert to radians
    group.scale.y = (yangle * Math.PI) / 180; // Convert to radians
}
        ...
        async function predictWebcam() {
            ...
            if (results.landmarks.length > 0 ) {
                ...
                if (l != null) {
                    ...
                    const p2 = results.landmarks[l][8];
                ...
                if (r != null) {
                    ...
                    const p22 = results.landmarks[r][8];
